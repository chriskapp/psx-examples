...
<p>This example demonstrates howto parse an simple ATOM feed</p>
...
<?php if(!isset($error)): ?>
	...
	<p>
		...
		<input type="url" name="url" id="url" value="<?php echo !empty($feedUrl) ? htmlspecialchars($feedUrl) : 'http://news.google.com/news?pz=1&cf=all&topic=t&output=atom'; ?>" style="width:312px;" />
	</p>
	<p>
