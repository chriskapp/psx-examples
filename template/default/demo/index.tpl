...
so you can also <a href="<?php echo $base; ?>/download/example.phpsx.org_07102012.zip">download</a> 
the complete source code. In some examples we use dummy data from a database. If 
you want test the examples local you have to create the following 
<a href="<?php echo $base; ?>/data.sql">table</a>. If an example does not work 
correctly or you are missing an specific use case do not hesitate to 
contact me.</p>
