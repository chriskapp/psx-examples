...
please contact me. Click here to <a href="<?php echo $url; ?>demo/oauth2_client/request_api/logout">logout</a></p>

<form method="post" action="<?php echo $url; ?>demo/oauth2_client/request_api">
